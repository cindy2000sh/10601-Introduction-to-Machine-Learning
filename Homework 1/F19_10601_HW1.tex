...
\section{Hello, Autolab! [29 Points]} 
...
\begin{enumerate}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ 5\%, 10\%, 15\%, 20\%
        \item $\circle$ 10\%, 20\%, 30\%, 40\%
        \item $\circle$ 25\%, 50\%, 75\%, 100\%
        \item $\CIRCLE$ 20\%, 40\%, 60\%, 80\%
    \end{list}
    ...
    \textbf{Select one:}
    \begin{list}{}
        \item $\circle$ As many as I want; Of course!
        \item $\CIRCLE$ 6; No
        \item $\circle$ 8; Yes
        \item $\circle$ 6; Yes
    \end{list}
    ...
    \begin{list}{}
        \item $\blacksquare$ No written notes are shared or taken at any time
        \item $\blacksquare$ Learning is facilitated not circumvented; i.e., the purpose of seeking help is to learn and understand the problem instead of merely getting an answer
        \item $\blacksquare$ Help both given and received is reported in collaboration questions in the homework
        \item $\blacksquare$ The student updates his/her collaborative questions even if it is after submitting their own assignment
    \end{list}

    
    \item \textbf{[0.5 pt]} Which of the following is (are) strictly forbidden in solving and submitting homework?
    
    \textbf{Select all that apply:}
    \begin{list}{}
        \item $\blacksquare$ Searching on the internet for solutions or sample codes
        \item $\blacksquare$ Consulting people outside this class who have seen or solved the problem before
        \item $\blacksquare$ Turning in someone else's homework
        \item $\blacksquare$ Using anyone else's, or allowing other classmates to use your computer, Autolab or Gradescope in connection with this course
    \end{list}

    
    \item \textbf{[0.5 pt]} If you solved your assignment completely on your own, you can skip the collaboration questions at the end of each homework.
    ...
    \item \textbf{[0.5 pt]} What is (are) the consequence(s) of being caught cheating in this course? Select all that apply.
    
    \textbf{First time:}
    \begin{list}{}
        \item $\blacksquare$ A one and a half letter grade reduction (e.g., \textbf{A} becomes \textbf{B-})
        \item $\blacksquare$ AIV report to university authorities
    \end{list}

    
    \textbf{Second time:}
    \begin{list}{}
        \item $\blacksquare$ Failure of the course
        \item $\blacksquare$ AIV report to university authorities
    \end{list}
...
\begin{enumerate}
    ...
    %solution
    \begin{center}\LARGE\( \frac{4}{5} \)\end{center}
    \end{tcolorbox}
...
\clearpage
    ...
    \begin{list}{}
        ...
        \item Uniform:  \qquad         
            \begin{tcolorbox}[fit,height=1cm, width=2cm, blank, borderline={1pt}{-2pt},nobeforeafter]
            %solution
            \begin{center}\Huge{d}\end{center}
            \end{tcolorbox}
        \item Bernoulli:  \qquad             
            \begin{tcolorbox}[fit,height=1cm, width=2cm, blank, borderline={1pt}{-2pt},nobeforeafter]
            %solution
            \begin{center}\Huge{e}\end{center}
            \end{tcolorbox}
        \item Binomial:  \qquad             
            \begin{tcolorbox}[fit,height=1cm, width=2cm, blank, borderline={1pt}{-2pt},nobeforeafter]
            %solution
...
\begin{enumerate}
    ...
    %solution
    \begin{center}\Huge{1, 2, 3, 5, 6, 4, 7, 8, 9, 10}\end{center}
    \end{tcolorbox}
    ...
    \begin{tcolorbox}[fit,height=1cm, width=\textwidth, blank, borderline={1pt}{-2pt},nobeforeafter]
    %solution
    \begin{center}\Huge{1, 2, 7, 3, 4, 8, 5, 6, 9, 10}\end{center}
    \end{tcolorbox}
    ...
    def find_val(node, key):
        ...
        if (1)_____node.val = key___________________:
            return node
            
        else:
            result = (2)___find_val(node.leftNode, key)__
            
            if result is None:
                result = (3)__find_val(node.rightNode, key)_
                
            return (4)_______result_______________
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item If you answered `yes', give full details: No\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
