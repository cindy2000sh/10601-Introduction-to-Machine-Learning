...
\begin{enumerate}
    ...
    \begin{list}{}
        \item $\blacksquare$ AND function, i.e., the function that evaluates to 1 if and only if all inputs are 1, and 0 otherwise.
        \item $\blacksquare$ OR function, i.e., the function that evaluates to 1 if and only if at least one of the inputs are 1, and 0 otherwise.
    ...
    \begin{list}{}
        ...
        \item $\blacksquare$ The perceptron algorithm can be used in the context of online learning.
    ...
    \begin{list}{}
        ...
        \item $\blacksquare$ If the whole dataset is shifted away from origin, then the mistake bound will also increase.
        \item $\blacksquare$ If the size of the data set (i.e., the maximum pair-wise distance between data points) is increased, then the mistake bound will also increase.
